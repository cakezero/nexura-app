    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 relative">
      ...
      <div className="absolute top-4 left-4">
        ...
        <CardDescription className="text-white/60 text-sm leading-relaxed pb-3">
          Link your official X (formerly Twitter) account to verify your
          organization’s identity.
        </CardDescription>

        {/* Action */}
        <Link href="/connected-twitter" className="w-full">
        <Button className="w-full text-white bg-purple-500 hover:bg-purple-600 flex items-center justify-center gap-2">
          <img
            src="/x-logo.png"
            alt="X logo"
            className="w-4 h-4"
