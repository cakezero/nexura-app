...
<div className="flex gap-4">
  ...
  <div className="flex-1 bg-[#006CD233] border border-[#393B60] rounded-xl p-4 flex flex-col gap-3">
    {/* Heading */}
    <span className="font-semibold text-lg text-[#006CD2]">SUPPORT</span> {/* increased from default */}
    ...
    <div className="flex items-center gap-3">
      ...
      <div className="flex items-center gap-2">
        <span className="text-blue-400 font-semibold text-base md:text-lg">{claim.support}</span> {/* increased */}
  ...
  <div className="w-full h-[280px]">
    <ResponsiveContainer width="100%" height="100%">
      <AreaChart data={generateChartData(claim, growthType)}>
        ...
        <Line
          type="monotone"
          dataKey={() => 101} // baseline yellow line
          stroke="#FFD166"
          strokeWidth={1.5}
          dot={false}
          activeDot={false}
...
<div className="flex rounded-full border border-[#006CD2] w-full h-12 overflow-hidden select-none cursor-pointer">
  ...
  <div
    ...
    className={`flex-1 flex items-center justify-center font-semibold text-lg transition-colors duration-300 ${
      isBuy ? "bg-[#8B3EFE] text-white" : "bg-[#060210] text-white"
    }`}
  >
    Buy
  </div>
...
<div className="w-[15%]">
  <div className="flex rounded-md border border-[#393B60] w-full h-12 overflow-hidden">
    ...
    <div
      ...
      className={`flex-1 flex items-center justify-center font-semibold text-lg transition-colors duration-300 cursor-pointer ${
