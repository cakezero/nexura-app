...
setUserPositions(myPositions);
  ...
  const counterPrices = counterTerm.vaults.map((v: any, i: number) => ({
    type: "counter",
L     { walletClient, publicClient, address },
      ...
      {userPositions.length > 0 ? (
        (() => {
          ...
          if (supportPosition) {
            ...
            return <span className="whitespace-nowrap">Support: <span className="text-white">{totalSupport} Shares</span></span>;
            ...
            return <span className="whitespace-nowrap">Oppose: <span className="text-white">{totalOppose} Shares</span></span>;
          } else {
