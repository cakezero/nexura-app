...
function LessonPageInner() {
  ...
  const isReview = searchParamsHook.get("review") === "1";
            ...
            <div className="relative px-4 sm:px-5 pt-3 sm:pt-5 pb-3 sm:pb-5 flex flex-col items-center">
              ...
              <a
                href={`https://x.com/intent/tweet?text=${encodeURIComponent(
                  `I just completed the ${lesson?.title ?? "a lesson"} lesson on @NexuraXYZ ✅\n\n${lesson?.reward ?? 0} XP secured\n\nSign up here: ${typeof window !== "undefined" ? window.location.origin : ""}/ref/${user?.referral?.code ?? "nexura"} and check it out in the Learn tab.`
                )}`}
                target="_blank"
